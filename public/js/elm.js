...
var author$project$Board$boardSize = A2(elm$core$List$range, 1, 100);
...
var author$project$Board$outOfBounds = _Utils_ap(
	A2(elm$core$List$range, 1, 10),
	_Utils_ap(
		A2(elm$core$List$range, 91, 100),
		_Utils_ap(
			A2(
				elm$core$List$map,
				function (n) {
...
var author$project$Board$isTileOutOfBounds = function (_int) {
	return A2(elm$core$List$member, _int, author$project$Board$outOfBounds);
};
var author$project$Types$Legal = {$: 'Legal'};
var author$project$Types$OutOfBounds = {$: 'OutOfBounds'};
var author$project$Board$getTileStatus = function (_int) {
	return author$project$Board$isTileOutOfBounds(_int) ? author$project$Types$OutOfBounds : author$project$Types$Legal;
};
var elm$core$Maybe$Nothing = {$: 'Nothing'};
var author$project$Board$createTile = function (_int) {
	return _Utils_Tuple3(
		_int,
		author$project$Board$getTileStatus(_int),
		elm$core$Maybe$Nothing);
};
var author$project$Board$createBoard = A2(elm$core$List$map, author$project$Board$createTile, author$project$Board$boardSize);
var author$project$Main$init = {board: author$project$Board$createBoard};
...
var author$project$Board$tileDiv = function (tile) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
...
var author$project$Board$chunk = F3(
	function (_int, list, acc) {
		return (_Utils_cmp(
			...
			_List_fromArray(
				[list])) : _Utils_ap(
			A3(
				author$project$Board$chunk,
				_int,
				A2(elm$core$List$drop, _int, list),
				acc),
			_List_fromArray(
				[
					A2(elm$core$List$take, _int, list)
				]));
	});
var author$project$Board$splitBoardIntoRows = function (tileList) {
	return A3(author$project$Board$chunk, 10, tileList, _List_Nil);
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						author$project$Board$renderBoard(model.board)
					])),
				A2(
